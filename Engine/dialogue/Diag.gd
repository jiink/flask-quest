...
var characters = {
	...
	"ribbit": ["res://Player/ribbit_sprites/ribbitFaces.png", "res://NPC/ribbit_speech.wav", 0.3, "Ribbit"],
	"dubble": ["res://NPC/Dubble/dubbleFaces.png", "res://NPC/old_person_speech.wav", 0.0, "Dubble"],
	"purple": ["res://NPC/Purple/purpleFaces.png", "res://NPC/default_voice2.wav", 0.2, "Purple"],
	}
